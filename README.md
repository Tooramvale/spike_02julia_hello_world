...
The developer is not aware or familiar with Julia and needs to setup their
workstation to compile code written in Julia for their future self-projects or
external projects.

## Goals/Deliverables:
**[GIT REPOSITORY (CODE)] + [SPIKE REPORT]**
- You need to create a simple "Hello World" application in Julia
- It needs to compile
...
This program should be the absolute minimum needed to write a program in Julia.
...
(and/or potentially other remote machines) to run your Julia code.
...
- Read the _online_ documentation for Julia
...
- Can you execute the compiled (or interpreted) program on another machine, if
  not why?
- Who and why did they invent Julia?
